...
openssl req -new -newkey rsa:4096 -days 18250 -nodes -x509 -subj "/C=privatebin/ST=privatebin/L=privatebin/O=privatebin/CN=privatebin" -keyout privatebin.key -out privatebin.cert
